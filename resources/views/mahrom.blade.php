...
<head>
  ...
  <title>Data Mahrom - Smart Boarding</title>
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <table id="mahrom" class="table table-bordered table-striped" width="inherit">
                    <thead>
                      <tr>
                        <th>No</th>
                        {{-- <th>Kodeapp</th> --}}
...
<script type="text/javascript">
  var table = $('#mahrom').DataTable({
    processing: true,
    serverSide: false,
    ajax: "{{ route('api.tampilmahrom') }}",
    responsive: true,
    autoWidth: true,
    columns: [
