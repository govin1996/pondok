    ...
    <section class="main-section">
        ...
        <div class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Peringatan Pulang</li>
          </ol>
        </div>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Peringatan Pulang</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                  ...
                  <table id="ppulang" class="table table-bordered table-striped" width="inherit">
                    <thead>
                      <tr>
                        <th>No</th>
                        <th>Hari</th>
...
<script type="text/javascript">
  var table = $('#ppulang').DataTable({
    processing: true,
    serverSide: false,
    ajax: "{{ route('api.tampilperingatanpulang') }}",
    responsive: true,
    autoWidth: true,
    columns: [
  ...
  $(function(){
    $('#modal-form form').validator().on('submit', function (e) {
        if (!e.isDefaultPrevented()) {
            var id = $('#id').val();
            if (save_method == 'add') url = "{{ url('/peringatanpulang') }}";
            else url = "{{ url('/peringatanpulang') . '/' }}" + id;
            $.ajax({
                url: url,
                type: "POST",
