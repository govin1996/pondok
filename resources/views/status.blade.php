...
<head>
  ...
  <title>Data Status - Smart Boarding</title>
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                  ...
                  <table id="status" class="table table-bordered table-striped" width="inherit">
                    <thead>
                      <tr>
                        <th>No</th>
                        <th>Status</th>
...
<script type="text/javascript">
  ...
  function addForm() {
    ...
    $('.modal-title').text('Tambah Data Status');
  }
  ...
  function editForm(id) {
      ...
      $('#modal-form form')[0].reset();
      $.ajax({
          url: "{{ url('/status') }}" + '/' + id + "/edit",
          type: "GET",
          dataType: "JSON",
          success: function(data) {
              $('#modal-form').modal('show');
              $('.modal-title').text('Edit Data Status');
              $('#id').val(data.id);
  ...
  $(function(){
    $('#modal-form form').validator().on('submit', function (e) {
        if (!e.isDefaultPrevented()) {
            var id = $('#id').val();
            if (save_method == 'add') url = "{{ url('/status') }}";
