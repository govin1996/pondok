        ...
        <div class="modal-content">
            <form id="form-contact" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div id="txt" class="wrap-input45 validate-input" data-validate="Enter Nis">
                        <span class="label-input100">Hari :</span>
                        <input class="input100" type="text" name="hari" id="hari" placeholder=". . . . .">
                        <span class="focus-input100" data-placeholder="Nama"></span>
                    </div>
                    <div id="txt" class="wrap-input45 validate-input" data-validate="Enter Nis">
                        <span class="label-input100">Jam :</span>
                        <input class="input50" type="time" name="jam" id="jam" placeholder=". . . . .">
                        <span class="focus-input100" data-placeholder="Nama"></span>
                    </div>
